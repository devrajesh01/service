...
const CustomCursor = () => {
    ...
    useEffect(()=>{
        ...
        const borderCursor = cursorBorderRef.current
        gsap.set([cursor, borderCursor],
            {xPercent: -50,
                yPercent: -50
            }
        );
        ...
        const xToBorder = gsap.quickTo(borderCursor, "x",{
            duration: 0.5 , ease: "power.out"
        })

        const yToBorder = gsap.quickTo(borderCursor, "y",{
